...
function checkAdminAuth(req: Request): boolean {
  ...
  const expected = `Basic ${btoa("Soekyawwin@93:" + adminPass)}`;
...
function requireAuth(): Response {
  return new Response("Unauthorized. Please provide admin password.", {
    status: 401,
    headers: { "WWW-Authenticate": 'Basic realm="Patgaduu Admin"' },
  });
}
...
<body>
  ...
  <div class="container">
    ...
    <div class="footer">
      Powered by <a href="https://t.me/iqowoq" target="_blank" rel="noopener">Patgaduu</a> &copy; 2026 | <a href="https://t.me/iqowoq" target="_blank" rel="noopener">Telegram</a>
    </div>
  </div>
